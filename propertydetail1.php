...
<div class="row">
    <div class="col-md-12">
        <h4 class="text-secondary mb-4">Virtual 360° Tour</h4>
...
<div class="row mt-4">
    <div class="col-md-12">
        <h4 class="text-secondary mb-4">Property Gallery</h4>
        <div id="single-property" style="width:1200px; height:700px; margin:30px auto 50px;">
            <!-- Keep existing slider code here -->
            <div class="ls-slide" data-ls="duration:7500; transition2d:5; kenburnszoom:in; kenburnsscale:1.2;"> <img width="1920" height="1080" src="admin/property/<?php echo $row['18'];?>" class="ls-bg" alt="" /> </div>
    ...
    <div class="col-md-6">
        <div class="text-success text-left h5 my-2 text-md-right">ETB <?php echo $row['12'];?></div>
        <div class="text-left text-md-right">Price</div>
        <!-- Add the "Book Now" button here -->
        <?php if ($row['status'] == 'available'): ?>
            <a href="book_property.php?property_id=<?php echo $row['pid']; ?>" class="btn btn-primary mt-2">Book Now</a>
        <?php else: ?>
...
<?php if (!empty($row['panorama_image'])) : ?>
<script src="https://cdn.jsdelivr.net/npm/pannellum@2.5.6/build/pannellum.js"></script>
<script>
document.addEventListener('DOMContentLoaded', function(){
    pannellum.viewer('panorama', {
        "type": "equirectangular",
        "panorama": "admin/property/<?php echo $row['panorama_image']; ?>",
        "autoLoad": true,
        "showControls": true,
        "compass": true,
        "mouseZoom": true,
        "preview": "admin/property/<?php echo $row['pimage1']; ?>"
    });
});
</script>
<?php endif; ?>
