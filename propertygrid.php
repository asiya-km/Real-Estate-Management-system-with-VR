...
<div id="page-wrapper">
					...
					<div class="col-lg-8">
                        <div class="row">
							...
							if(isset($_REQUEST['filter']))
							{
								...
								//$sql="SELECT property.*, user.uname FROM `property`,`user` WHERE property.uid=user.uid or type='{$type}' or stype='{$stype}' or city='{$city}'";
    ...
    <div class="price text-primary text-capitalize">ETB <?php echo $row['10'];?> <span class="text-white"><?php echo $row['9'];?> Sqft</span></div>
</div>
