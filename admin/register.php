...
if(isset($_REQUEST['insert']))
{
	...
	{ 
	 ...
	 if(!validatePassword($pass) && !validatePhone($phone)){ $error = "<p class='alert alert-warning'>password must be 8 chars with uppercase,lowercase,num,special and phone 10 digits</p>";
		}
	 else{  
