...
<head>
        ...
        <title>Remsko - Admin Dashboard</title>
                            ...
                            <div class="card-body">
                                <div class="dash-widget-header">
                                    ...
                                    <div class="dash-widget-info">
                                        <?php
                                        // Get total payments
                                        $payment_query = "SELECT COUNT(*) as total, SUM(payment_amount) as amount FROM bookings WHERE payment_status = 'completed'";
                                        $payment_result = mysqli_query($con, $payment_query);
                                        $payment_data = mysqli_fetch_assoc($payment_result);
                                        ?>
                                        <h3><?php echo number_format($payment_data['total']); ?></h3>
                                        <h6 class="text-muted">Completed Payments</h6>
                                        <p class="text-success">ETB <?php echo number_format($payment_data['amount'], 2); ?></p>
                                        <div class="progress progress-sm">
                            ...
                            <div class="card-body">
                                <div class="dash-widget-header">
                                    ...
                                    <div class="dash-widget-info">
                                        ...
                                        $pending_query = "SELECT COUNT(*) as total FROM bookings WHERE payment_status = 'pending'";
            ...
            <div class="stat-category">
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <a href="propertyview.php" class="card quick-action-card">
                            <i class="fe fe-list text-primary"></i>
                            <h5>View Properties</h5>
                        </a>
                    </div>
                    <div class="col-md-3 col-sm-6">
                        <a href="userlist.php" class="card quick-action-card">
                            <i class="fe fe-users text-success"></i>
                            <h5>Manage Users</h5>
                        </a>
                    </div>
                    <div class="col-md-3 col-sm-6">
                        <a href="contactview.php" class="card quick-action-card">
                            <i class="fe fe-mail text-warning"></i>
                            <h5>Contact Messages</h5>
                        </a>
                    </div>
                    <div class="col-md-3 col-sm-6">
                        <a href="admin_bookings.php" class="card quick-action-card">
