...
if(isset($_POST['update_pwd'])) {
    ...
    if(empty($old_password) || empty($new_password) || empty($confirm_password)) {
        ...
        // Verify old password
        $sql = "SELECT * FROM user WHERE uname='$auser'";
        ...
        if($result && mysqli_num_rows($result) > 0) {
            ...
            if($old_password == $stored_password) { // Simple comparison for now
                // Update password
                $update_sql = "UPDATE user SET upass='$new_password' WHERE uname='$auser'";
            ...
            $error_message = "Manager user not found";
        }
    }
}
...
$sql = "SELECT * FROM user WHERE (uemail='$id' OR uname='$id')";
$result = mysqli_query($con, $sql);
...
<head>
    ...
    <title>Remsko - Manager Profile</title>
                            ...
                            <div class="row align-items-center">
                                <div class="col-auto profile-image">
                                    <a href="#">
                                        ...
                                        <img src="../admin/user/<?php echo $row['6']; ?>" height="50px" width="50px">
                                    </a>
                                </div>
                                <div class="col ml-md-n2 profile-user-info">
                                    ...
                                    <div class="user-Location"><i class="fa fa-id-badge" aria-hidden="true"></i>
                                        <?php echo htmlspecialchars($row['uphone']); ?></div>
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <p class="col-sm-9"><?php echo htmlspecialchars($row['uname']); ?></p>
                                                </div>
                                                <div class="row">
                                                    <p class="col-sm-3 text-muted text-sm-right mb-0 mb-sm-3">UID</p>
                                                    <p class="col-sm-9"><?php echo htmlspecialchars($row['uid']); ?></p>
                                                </div>
                                                <div class="row">
                                                    <p class="col-sm-3 text-muted text-sm-right mb-0 mb-sm-3">Email ID</p>
                                                    <p class="col-sm-9"><a href="mailto:<?php echo htmlspecialchars($row['uemail']); ?>"><?php echo htmlspecialchars($row['2']); ?></a></p>
                                                </div>
                                                <div class="row">
                                                    <p class="col-sm-3 text-muted text-sm-right mb-0 mb-sm-3">Mobile</p>
                                                    <p class="col-sm-9"><?php echo htmlspecialchars($row['uphone']); ?></p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
