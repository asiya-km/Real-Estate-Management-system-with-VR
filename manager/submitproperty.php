...
$error="";
$msg="";
// In property submission form processing
if($_FILES['aimage']['type'] != 'image/jpeg') {
    $error = "360° images must be JPEG format";
}
if(isset($_POST['add']))
{
	...
	$panorama_image=$_FILES['panorama_image']['name'];
	...
	$temp_panorama = $_FILES['panorama_image']['tmp_name'];
	...
	move_uploaded_file($temp_panorama, "admin/property/$panorama_image");
	...
	$sql="insert into property (title,pcontent,type,stype,bedroom,bathroom,balcony,kitchen,hall,floor,size,price,location,city,state,feature,pimage,pimage1,pimage2,pimage3,pimage4,panorama_image,uid,status,mapimage,topmapimage,groundmapimage,totalfloor, isFeatured)
	values('$title','$content','$ptype','$stype','$bed','$bath','$balc','$kitc','$hall','$floor','$asize','$price',
	'$loc','$city','$state','$feature','$aimage','$aimage1','$aimage2','$aimage3','$aimage4','$panorama_image','$uid','$status','$fimage','$fimage1','$fimage2','$totalfloor', '$isFeatured')";
									...
									<?php echo $msg; ?>
										...
										<div class="row">
											<div class="col-xl-6">
												...
												<!-- In your property submission form -->
<div class="form-group row">
    <label class="col-lg-3 col-form-label">360° Panorama Image</label>
    <div class="col-lg-9">
        <input class="form-control" name="panorama_image" type="file" accept="image/jpeg">
        <small class="text-muted">Upload 360° equirectangular JPEG image</small>
    </div>
</div>
												<div class="form-group row">
