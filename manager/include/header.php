                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <ul class="top-contact list-text-white  d-table">
                                ...
                                <li><a href="#"><i class="fas fa-envelope text-success mr-1"></i>MAL@realestatest.com</a></li>
                            </ul>
                        </div>
                        <div class="col-md-4">
                                       ...
                                       <!-- <li class="nav-item"> <a class="nav-link" href="agent.php">Agent</a> </li>-->
										...
										<li class="nav-item dropdown">
											...
											<ul class="dropdown-menu">
                                                ...
                                                <li class="nav-item"> <a href="user_dashboard.php" class="btn btn-success">My Bookings</a></li>
