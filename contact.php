                            ...
                            <ul>
                                <li class="d-flex mb-4"> <i class="fas fa-map-marker-alt text-white mr-2 font-13 mt-1"></i>
                                    <div class="contact-address">
                                        ...
                                        <span class="text-white">22 Mazoria , Golagul Tower , 8th Floor , Room No #804 , Addis Ababa, Ethiopia</span> <br>
										<span class="text-white">22 Mazoria , Golagul Tower , 8th Floor , Room No #804 , Addis Ababa, Ethiopia</span>
										</div>
                                </li>
                                <li class="d-flex mb-4"> <i class="fas fa-phone-alt text-white mr-2 font-13 mt-1"></i>
                                    <div class="contact-address">
                                        <h5 class="text-white">Call Us</h5>
                                        <span class="d-table text-white">+251-948-83-83-83</span>
										<span class="text-white">+251-948-83-83-83</span>
									</div>
                                </li>
                                <li class="d-flex mb-4"> <i class="fas fa-envelope text-white mr-2 font-13 mt-1"></i>
                                    <div class="contact-address">
                                        <h5 class="text-white">Email Adderss</h5>
										<span class="d-table text-white">legacybuilderset@gmail.com</span>
										<span class="text-white">legacybuilderset@gmail.com</span>
										</div>
                                </li>
                            </ul>
                        </div>
