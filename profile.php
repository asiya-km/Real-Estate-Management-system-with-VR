                    ...
                    <div class="col-md-6">
                        <nav aria-label="breadcrumb" class="float-left float-md-right">
                            <ol class="breadcrumb bg-transparent m-0 p-0">
                                ...
                                <li class="breadcrumb-item active"><a href="updateprofile.php">Update profile</a></li>
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name" class="form-control" placeholder="Enter Full Name"  value="<?php echo htmlspecialchars($row['uname'] ?? ''); ?>">
                                </div>                
                                
                                <div class="form-group">
                                    <label for="phone">Contact Number</label>
                                    <input type="text" name="phone"  class="form-control" placeholder="Enter Phone" maxlength="10" value="<?php echo htmlspecialchars($row['3'] ?? ''); ?>" >
                                </div>
